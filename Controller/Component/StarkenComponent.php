	...
	public function generar_ot($venta, $embalaje, $CuentaCorrienteTransporte)
	{
		...
		foreach ($paquetes as $paquete) {
			...
			$data = array(
				...
				'nombreRazonSocialDestinatario'     => inflector::slug(substr($venta['VentaCliente']['nombre'], 0, 40), ' '),
				'apellidoPaternoDestinatario'       => inflector::slug(substr($venta['VentaCliente']['apellido'], 0, 20), ' '),
				'apellidoMaternoDestinatario'       => '.',
				'direccionDestinatario'             => inflector::slug(substr(trim($venta['Venta']['direccion_entrega']), 0, 80), ' '),
				'numeracionDireccionDestinatario'   => inflector::slug(substr(trim($venta['Venta']['numero_entrega']), 0, 10), ' '),
				'departamentoDireccionDestinatario' => inflector::slug(substr(trim($venta['Venta']['otro_entrega']), 0, 10), ' '),
				...
				'nombreContactoDestinatario'        => inflector::slug(trim($venta['VentaCliente']['nombre']) . ' ' . trim($venta['VentaCliente']['apellido']), ' '),
				...
				'observacion'                       => inflector::slug('OT generada automáticamente por ' . $venta['Tienda']['nombre'] . ' - Venta Ref: ' . $venta['Venta']['referencia'], ' '),
				'encargos' => array(
					0 => array(
