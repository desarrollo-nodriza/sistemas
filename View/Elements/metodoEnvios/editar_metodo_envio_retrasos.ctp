<tr class="">
    ...
    <td>
        <?= $this->Form->input(sprintf('MetodoEnvioRetraso.%d.horas_retraso', $regla_retraso['id']), array('type' => 'text', 'class' => 'form-control js-digits js-hora-regla-noti', 'placeholder' => 'Ej: 10, 5, 24', 'min' => 1,  'value' => $regla_retraso['horas_retraso'])); ?>
    </td>
    <td>
