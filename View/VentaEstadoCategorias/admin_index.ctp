						...
						<table class="table table-striped listado-ventas">
							...
							<thead>
								<tr class="sort">
									...
									<th><?= $this->Paginator->sort('envio', 'Enviado', array('title' => 'Haz click para ordenar por este criterio')); ?></th>
							...
							<tbody>
								...
								<?php foreach ( $ventaEstadoCategorias as $ventaEstadoCategoria ) : ?>
									...
									<tr>
										...
										<td><?= ($ventaEstadoCategoria['VentaEstadoCategoria']['envio'] ? '<i class="fa fa-check"></i>' : '<i class="fa fa-remove"></i>'); ?>&nbsp;</td>
