<div class="table-responsive tabla-cotizacion">
	<table>
		...
		<tr>
			...
			<td style="vertical-align: middle; font-size: 30px; font-weight: bold; text-align: center;">
				Cotización <?= (Configure::read('debug') > 1) ? 'DEV' : $cotizacion['Cotizacion']['id'];?>
			</td>
		</tr>
	</table>
	<table>
	...
	<table>
		...
		<? foreach ($cotizacion['VentaDetalleProducto'] as $inx => $producto) : ?>
			<tr>
		...
		<? endforeach; ?>
		<tr>
			<td colspan="4"><b>Total Neto</b></td><td><?=CakeNumber::currency($cotizacion['Cotizacion']['total_neto'], 'CLP'); ?></td>
		</tr>
		<tr>
			<td colspan="4"><b>IVA</b></td><td><?=CakeNumber::currency($cotizacion['Cotizacion']['iva'], 'CLP'); ?></td>
		</tr>
		<? if (!empty($cotizacion['Transporte']['id'])) : ?>
		<tr>
			<td colspan="4"><b><?= $cotizacion['Transporte']['nombre']; ?></b></td><td><?=CakeNumber::currency($cotizacion['Cotizacion']['transporte'], 'CLP'); ?></td>
		</tr>
		<? endif; ?>
		<tr>
			<td colspan="4"><b>Descuento</b></td><td><?=CakeNumber::currency($cotizacion['Cotizacion']['descuento'], 'CLP'); ?></td>
		</tr>
		<tr>
			<td colspan="4"><b>Total</b></td><td><?=CakeNumber::currency($cotizacion['Cotizacion']['total_bruto'], 'CLP'); ?></td>
		</tr>
	</table>
