			...
			<div class="panel panel-default tabs">
				...
				<div class="tab-content">
					...
					<div class="tab-pane panel-body active" id="tab-venta">
								...
								<div class="panel-body">
									...
									<div class="table-responsive">
										<table class="table table-bordered">
											...
											<tr>
												<th>Marketplace</th>
												<td><?php if (!empty($venta['Venta']['marketplace_id'])) {
														echo $venta['Marketplace']['nombre'];
													} ?>&nbsp;</td>
											</tr>
											<tr>
												<th>Atendida</th>
									...
									<div class="table-responsive">
										<table class="table table-bordered">
											...
											<tbody>
												...
												foreach ($venta['VentaDetalle'] as $indice => $detalle) : $TotalProductos = $TotalProductos + ($detalle['precio'] * $detalle['cantidad'] - $detalle['monto_anulado']); ?>
											...
											<tfoot>
												...
												<tr>
													...
													<td>
														<?php if (!empty($venta['Venta']['descuento'])) {
															echo CakeNumber::currency($venta['Venta']['descuento'], 'CLP');
														} ?>
												...
												<tr>
													...
													<td>
														...
														<?php if (!empty($venta['Venta']['costo_envio'])) {
															echo CakeNumber::currency($venta['Venta']['costo_envio'], 'CLP');
														} ?>
													</td>
												</tr>
												<tr class="success">
						...
						<div class="col-xs-12 col-sm-4">
							...
							<? if (!empty($venta['Venta']['etiqueta_envio_externa'])) : ?>
								...
								<a href="<?= $venta['Venta']['etiqueta_envio_externa'] ?>" target="_blank" class="tile small tile-info"><i class="fa fa-truck"></i>
									<p>Etiqueta Externa</p>
								</a>
												...
												<div class="panel-body list-group">
													<div class="table-responsive">
														<table class="table table-striped table-bordered">
															...
															<tbody>
																<?php $TotalProductos = 0;
																foreach ($venta['VentaDetalle'] as $indice => $detalle) : $TotalProductos = $TotalProductos + ($detalle['precio'] * $detalle['cantidad']); ?>
																	<tr>
																		<td>
																			<?= $detalle['VentaDetalleProducto']['id']; ?>
												...
												if (!empty($venta['Dte'])) :
													foreach ($venta['Dte'] as $dte) : ?>
														<tr>
															...
															<td><?= $dte['revision_detalle']; ?></td>
															<td style="text-align-last: center;"><?= $dteinvalidado = ($dte['invalidado']) ? '<i class="fa fa-check"></i>' : '<i class="fa fa-close"></i>'; ?>&nbsp;</td>
															<td>
																<div class="btn-group">
					...
					<div class="tab-pane panel-body" id="tab-embalajes">
						...
						<div class="messages">
							<? foreach ($notas_despacho['body'] as $nota) : if (!empty($nota['embalajes'])) : continue;
								endif; ?>
