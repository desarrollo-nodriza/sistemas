	...
	<table>
		<tr>
			<td style="width: 50%; padding: 10px; border-color: #000;">
				<table>
					<tr>
						<td style="font-size: 14px;"><strong>Destinatario</strong></td>
					</tr>
					<tr>
						<td style="font-size: 14px;">Nombre: <?=$venta['Envio'][0]['nombre_receptor']; ?></td>
					</tr>
					<tr>
						<td style="font-size: 14px;">Rut: <?=$this->Html->rut($venta['VentaCliente']['rut']); ?></td>
					</tr>
					<tr>
						<td style="font-size: 14px;">Dirección: <?=$venta['Envio'][0]['direccion_envio']; ?></td>
					</tr>
					<tr>
						<td style="font-size: 14px;">Fono: <?=$venta['Envio'][0]['fono_receptor']; ?></td>
					</tr>
				</table>

				<table>
					<tr>
						<td style="font-size: 14px;"><strong>Detalle de la compra</strong></td>
					</tr>
					<tr>
					...
					<? if (!empty($venta['Dte'])) : ?>
					<tr>
						<td style="font-size: 14px;">Folio: <?=implode(', ', Hash::extract($venta['Dte'], '{n}.folio'));?></td>
					</tr>
					<? endif; ?>
					<tr>
						<td style="font-size: 14px;">Transportista: <?=$venta['VentaExterna']['transportista']; ?></td>
					</tr>
					<tr>
						<td style="font-size: 14px;">Medio de pago: <?=$venta['MedioPago']['nombre']; ?></td>
					</tr>
				</table>
			...
			<td style="width: 50%; padding: 10px; border-color: #000;">
				<table>
					<tr>
						<td style="font-size: 14px;"><strong>Mensajes de la compra</strong></td><td></td>
					</tr>
					<tr>
						<td style="font-size: 14px;">
