					...
					<div class="panel-body">
						...
						<div class="col-xs-6 col-sm-6 col-md-3 col-lg-2">
							<div class="form-group">
								...
								<?= $this->Form->select('administrador_id', $vendedores, array('class' => 'form-control select', 'data-live-search' => true, 'multiple' => true, 'empty' => false, 'required' => false, 'default' => $FiltroAdministrador)); ?>
							</div>
						</div>
