                                    ...
                                    <tr>
                                      <td style="border-collapse: collapse; border-spacing: 0px; font-size: 16px; line-height: 24px; margin: 0; padding: 20px;" width="100%">
                                        <div>
                                          ...
                                          <h4 class="text-center" style="color: inherit; font-size: 24px; font-weight: 500; line-height: 26.4px; margin-top: 30px; margin-bottom: 30px; text-align: center; vertical-align: baseline;"> Estamos trabajando en tu pedido</h4>
                                          <!-- /Titulo -->
                                          ...
                                          Estimado/a <strong><?=$venta['VentaCliente']['nombre']; ?></strong>, te informamos que hemos tenido un pequeño retraso con el procesamiento de tu pedido, pero no te preocupes. Estamos trabajando <strong>a toda máquina</strong> para poder realizar la entrega lo antes posible tu compra.
                                          </p>
                                          <!-- /Parrafo -->
