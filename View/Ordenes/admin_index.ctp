<div class="page-title">
	<h2><span class="fa fa-money"></span> Ordenes de compra</h2>
</div>

<div class="page-content-wrap">
	<div class="row">
		<div class="col-xs-12">
			<?= $this->Form->create('Filtro', array('url' => array('controller' => 'ordenes', 'action' => 'index'), 'inputDefaults' => array('div' => false, 'label' => false))); ?>
			<? 
				...
				$dte_filtro = (isset($this->request->params['named']['dte'])) ? $this->request->params['named']['dte'] : '' ;
			?>
						...
						<table class="table table-striped">
							<thead>
								<tr class="sort">
									...
									<th><?= $this->Paginator->sort('dte', 'Dte', array('title' => 'Haz click para ordenar por este criterio')); ?></th>
									<th>Acciones</th>
								</tr>
							</thead>
							<tbody>
								...
								<tr>
									...
									<td><?= $dte = (!empty($orden['Dte'])) ? '<label class="label label-success">' . count($orden['Dte']) . ' Dte emitido/s' . '</label>' : $this->Html->dteEstado() ; ?>&nbsp;</td>
									<td>
									<? if ($permisos['edit']) : ?>
									<?= $this->Html->link('<i class="fa fa-eye"></i> Ver Dte´s', array('action' => 'orden', $orden['Orden']['id_order']), array('class' => 'btn btn-xs btn-info', 'rel' => 'tooltip', 'title' => 'Ver documentos emitidos para esta orden', 'escape' => false)); ?>
									<? endif; ?>
