<div class="page-title">
	<h2><span class="fa fa-upload"></span> Inventario inicial</h2>
</div>
...
<div class="page-content-wrap">
	...
	<div class="row">
		<div class="col-xs-12 col-md-6 col-md-offset-3">
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="fa fa-upload" aria-hidden="true"></i> Cargar archivos</h3>
				</div>
				<div class="panel-body">
					<div class="form-group col-xs-12">
						<label>Descarga el archivo de ejemplo</label>
						<br>
						<?=$this->Html->link('<i class="fa fa-download"></i> Ejemplo', '/ejemplos/ejemplo-ii-producto.csv', array('escape' => false, 'target' => '_blank', 'fullbase' => true, 'class' => 'btn btn-xs btn-info')); ?>
					</div>
					<div class="form-group col-xs-12 col-md-6">
						<label>Archivo CSV,XLS,XLSX</label>
						<?=$this->Form->input('archivo', array(
							'class' => '<?=(empty($this->Session->read("InventarioInicial"))) ? "not-blank" : "" ; ?>',
							'type' => 'file'
							))?>
					</div>
				</div>
		...
		<div class="col-xs-12">
			<? if (!empty($this->Session->read('InventarioInicial.options'))) : ?>
			<div class="panel panel-primary">
				<div class="panel-heading">
				</div>
				<div class="panel-body">
					...
					<div class="table-responsive" style="max-height: 350px; overflow-y: auto;">
						<table class="table table-bordered" >
							...
							<thead>
								<? foreach ($this->Session->read('InventarioInicial.options') as $i => $cabecera) : ?>
								<th>
									<div class="form-group">
										<label>
											<?=strtoupper($cabecera);?>
										</label>
										<?=$this->Form->select('Indice.' . $i, array('id_producto' => 'Id del producto', 'stock' => 'Stock', 'costo' => 'Costo inicial'), array('class' => 'form-control', 'empty' => 'Seleccione'));?>
									</div>
								</th>
								<? endforeach; ?>
							</thead>
							<tbody class="js-body">
							<? foreach ($this->Session->read('InventarioInicial.data') as $id => $valor) : if ($id == 1) continue; ?>
							<tr>
								<? foreach ($this->Session->read('InventarioInicial.options') as $i => $op) : ?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<h4><b>¡Atento!</b> Al realizar un ingreso inicial de inventario, se eliminarán todos los movimientos I/O anteriores del producto y bodega seleccionada.</h4>
      	<hr>
