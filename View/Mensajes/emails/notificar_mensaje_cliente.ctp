                                      ...
                                      <td style="border-collapse: collapse; border-spacing: 0px; font-size: 16px; line-height: 24px; margin: 0; padding: 20px;" width="100%">
                                        <div>
                                          ...
                                          <div style="text-align: center;">
                                            <img src="<?=$url;?>img/toolmania/iconos/delivery-truck.png" style="max-width: 100%; margin-top: 40px;" width="60">
                                          </div>-->
                                          <h4 class="text-center" style="color: inherit; font-size: 24px; font-weight: 500; line-height: 26.4px; margin-top: 50px; margin-bottom: 30px; text-align: center; vertical-align: baseline;">¡Haz recibido un nuevo mensaje!</h4>
                                          <!-- /Titulo -->


                                          <!-- Venta ID -->
                                          <h4 class="text-center" style="color: inherit; font-size: 33px; font-weight: 700; line-height: 36px; margin-top: 30px; margin-bottom: 30px; text-align: center; vertical-align: baseline;">N° Venta #<?=$mensaje['Mensaje']['venta_id'];?></h4>
                                          <!-- /Venta ID -->
                                          ...
                                          <p class="text-muted text-center" style="color: #636c72; font-size: 16px; font-weight: 500; line-height: 22px; margin-bottom: 30px; margin-top: 25px; text-align: center; vertical-align: baseline;">
                                            Estimad@ <?=$nombre_destinatario;?> para ver el mensaje ingresa al siguiente link.
                                          </p>
                                          <!-- /Parrafo -->

                                          <a href="<?=$url?>cliente/mis-compras/<?=$mensaje['Mensaje']['venta_id'];?>?tab=mensajes&mensaje=<?=$mensaje['Mensaje']['id'];?>" style="width: 100%; border-radius: 4px; display: block; line-height: 50px; background-color: #294D99; color: #fff; border: 0; text-align: center;">Ir al centro de mensajes</a>
                          ...
                          <tbody>
                            <tr>
                              <td style="border-collapse: collapse; border-spacing: 0px; border-top: 0; font-size: 16px; line-height: 30px; margin: 0; padding: 0; width: 100%;" valign="top">
                                <a href="https://<?=$tienda['Tienda']['url'];?>" style="width: 100%; display: block; line-height: 50px; background-color: #F55A00; color: #fff; border: 0; text-align: center;">Ir a la tienda</a>
                              </td>
                            </tr>
                          </tbody>
                        </table>
