              ...
              <TR style="HEIGHT: 20px">
                <TD style="BORDER-TOP: medium none; BORDER-RIGHT: medium none; WIDTH: 100%; VERTICAL-ALIGN: top; BORDER-BOTTOM: medium none; PADDING-BOTTOM: 0px; TEXT-ALIGN: center; PADDING-TOP: 35px; PADDING-LEFT: 15px; BORDER-LEFT: medium none; PADDING-RIGHT: 15px; BACKGROUND-COLOR: #feffff">
                  <P style="FONT-SIZE: 16px; FONT-FAMILY: Arial, Helvetica, sans-serif; MARGIN-TOP: 0px; COLOR: #a8a7a7; LINE-HEIGHT: 155%; BACKGROUND-COLOR: transparent; mso-line-height-rule: exactly" align=left>
                    <STRONG>El cliente <?=$mensaje['VentaCliente']['nombre']; ?> ha enviado un nuevo mensaje para la venta <?=$mensaje['Mensaje']['venta_id']; ?>.</STRONG>
                  </P>
                  ...
                  <BR>Para ver el mensaje ingrese al siguiente link:
                  <BR>
                    <a href="<?=$url;?>ventas/view/<?=$mensaje['Mensaje']['venta_id'];?>#mensajes" style="background-color:#771D97; font-size: 14px; font-family: arial, helvetica, sans-serif; color: #ffffff; padding: 5px 15px; text-decoration: none; margin-top: 20px; display: inline-block; text-align: center;">Ir a la venta</a>
                  <BR>
                  <BR>
