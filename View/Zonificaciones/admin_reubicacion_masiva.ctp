<div class="page-title">
	<h2><span class="fa fa-tags"></span> Reubicación Masiva</h2>
</div>
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div class="form-group col-xs-12">
						...
						<br>
						<?= $this->Html->link('<i class="fa fa-download"></i> Plantilla con stock actual', array('controller' => 'zonificaciones','action' => 'exportar_stock_ubicacion', $id), array('class' => 'btn btn-success', 'escape' => false)); ?>
