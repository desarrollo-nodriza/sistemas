<div class="page-title">
	<h2><i class="fa fa-list" aria-hidden="true"></i> OC<?= ClassRegistry::init('OrdenCompra')->tipo_orden_abreviacion[$oc['OrdenCompra']['tipo_orden']]; ?>-<?= $oc['OrdenCompra']['id'] ?></h2>
</div>
			...
			<div class="panel panel-info">
				<div class="panel-heading">
					...
					<div class="btn-group pull-right">
						<?= $this->Html->link('Recrear PDF', array('action' => 'generar_pdf',$oc['OrdenCompra']['id']), array(
							'class' => 'btn btn-danger btn-lg btn-bloc start-loading-then-redirect',
							'escape' => false
						)); ?>
						<!-- <?= $this->Html->link(
							'Recrear PDF',
							"ordenCompra/generar_pdf/{$oc['OrdenCompra']['id']}",
							array(
								'class' => 'btn btn-danger btn-lg btn-bloc start-loading-then-redirect',
							)
						); ?> -->
