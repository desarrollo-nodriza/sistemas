<div class="page-title">
	<h2><span class="fa fa-list"></span> Ordenes de compra listas para enviar</h2>
</div>
					...
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								...
								<?=$this->element('ordenCompras/index_tr', array('ordenCompra' => $ordenCompra, 'accion' => array('enviar')));?>
