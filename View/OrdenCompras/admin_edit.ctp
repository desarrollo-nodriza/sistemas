...
<script type="text/javascript">
	...
	{	
		...
		if (cargarOrdenes) {
			...
			data = {
				'id' : <?=$this->request->data['OrdenCompra']['id'];?>,
				'limit' : $limit,
				'offset' : $offset
			};
	...
	function crearInput()
	{	
		$("#OrdenCompraAdminEditForm").append('<input id="venta_' + $seleccionado.val() + '" type="hidden" name="data[Venta][][venta_id]"/ value="' + $seleccionado.val() + '">');
	}
