		...
		<div class="col-xs-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Listado de Validez Fechas</h3>
					<div class="btn-group pull-right">
						<?= $this->Html->link('<i class="fa fa-plus"></i> Nuevo Validez Fecha', array('action' => 'add'), array('class' => 'btn btn-success', 'escape' => false)); ?>
