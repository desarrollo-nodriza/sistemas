                                    ...
                                    <tr>
                                      <td style="border-collapse: collapse; border-spacing: 0px; font-size: 16px; line-height: 24px; margin: 0; padding: 20px;" width="100%">
                                        <div>
                                          ...
                                          <h4 class="text-center" style="color: inherit; font-size: 24px; font-weight: 500; line-height: 26.4px; margin-top: 30px; margin-bottom: 30px; text-align: center; vertical-align: baseline;">¡Seguimos trabajando!</h4>
                                          <!-- /Titulo -->
                                          ...
                                          Estimado/a <strong><?=$venta['VentaCliente']['nombre']; ?></strong>, te informamos que seguimos trabajando en la preparación de tu compra.
                                          </p>
                                          <!-- /Parrafo -->
