                                      ...
                                      <td style="border-collapse: collapse; border-spacing: 0px; font-size: 16px; line-height: 24px; margin: 0; padding: 20px;" width="100%">
                                        <div>
                                          ...
                                          <div style="text-align: center;">
                                            <img src="<?=$url;?>/img/toolmania/iconos/clock-2.png" style="max-width: 100%; margin-top: 40px;" width="50">
                                          </div>
                                          <h4 class="text-center" style="color: inherit; font-size: 24px; font-weight: 500; line-height: 26.4px; margin-top: 30px; margin-bottom: 30px; text-align: center; vertical-align: baseline;">5° aviso Estamos trabajando en tu pedido</h4>
                                          <!-- /Titulo -->
                                          ...
                                          <!-- Parrafo -->
                                          <p class="text-muted text-center" style="color: #636c72; font-size: 16px; font-weight: 500; line-height: 24px; margin-bottom: 10px; margin-top: 0px; text-align: justify; vertical-align: baseline;">
                                          Estimado/a <strong><?=$venta['VentaCliente']['nombre']; ?></strong>, te informamos que hemos tenido algunos retrasos con el procesamiento de tu pedido, pero no te preocupes. Estamos trabajando <strong>a toda máquina</strong> para poder entregarte lo antes posible tu compra.
                                          </p>
                                          <!-- /Parrafo -->
                                        
                                          <!-- Parrafo -->
                                          <p class="text-muted text-center" style="color: #636c72; font-size: 16px; font-weight: 500; line-height: 24px; margin-bottom: 10px; margin-top: 0px; text-align: justify; vertical-align: baseline;">
                                          Te pedimos nuestras más sinceras disculpas, pero aveces hay factores externos que hacen un poco más lento nuestro proceso. <strong>Te notificaremos vía email</strong> cuando tu compra haya cambiado de estado.    
                                          </p>
                                          <!-- /Parrafo -->

                                          <!-- Parrafo -->
                                          <p class="text-muted text-center" style="color: #636c72; font-size: 16px; font-weight: 600; line-height: 26px; margin-bottom: 10px; margin-top: 20px; text-align: center; vertical-align: baseline;">
                                          Muchas gracias por la comprensión. Atte Equipo <?=$venta['Tienda']['nombre'];?>    
                                          </p>
                                          <!-- /Parrafo -->
                                        </div>
                                      </td>
                        ...
                        <tr>
                          ...
                          <td class="text-right" style="border-bottom: 0; border-collapse: collapse; border-spacing: 0px; border-top: 0; font-size: 16px; line-height: 24px; margin: 0; width: 70%" align="right">
                            <a href="https://www.google.cl/maps/@-33.4481791,-70.8488174,17z">
                              <img src="<?=$url;?>/img/toolmania/toolmania-maps.png" style="max-width: 100%;" width="300">
                            </a>
                          </td>
                        </tr>
                      </tbody>
