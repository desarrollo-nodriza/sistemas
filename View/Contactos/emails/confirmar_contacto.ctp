                                      ...
                                      <td style="border-collapse: collapse; border-spacing: 0px; font-size: 16px; line-height: 24px; margin: 0; padding: 20px;" width="100%">
                                        <div>
                                          ...
                                          <div style="text-align: center;">
                                            <img src="<?=$url;?>/img/toolmania/iconos/people.png" style="max-width: 100%; margin-top: 40px;" width="50">
                                          </div>

                                          <!-- Titulo -->
                                          <h4 class="text-center" style="color: inherit; font-size: 24px; font-weight: 500; line-height: 26.4px; margin-top: 30px; margin-bottom: 30px; text-align: center; vertical-align: baseline;">¿Hemos resuelto tu requerimiento?</h4>
                                          <!-- /Titulo -->

                                          <!-- Sub titulo -->
                                          <h5 class="text-muted text-center" style="color: #636c72; font-size: 20px; font-weight: 700; line-height: 22px; margin-bottom: 0px; margin-top: 0px; text-align: center; vertical-align: baseline;">Estimado/a <?=$contacto['Contacto']['nombre_contacto']; ?> hemos marcado su requerimiento n° <?=$contacto['Contacto']['id']?> como <strong>atendido</strong></strong>. Por favor confirme si esta información es correcta.</h5>
                                          <!-- /Sub titulo -->
                                        
                                          <!-- Titulo tus productos -->
                                          <h5 class="text-center" style="color: inherit; font-size: 20px; font-weight: 700; line-height: 22px; margin-bottom: 20px; margin-top: 40px; text-align: center; vertical-align: baseline;">Detalles del requerimiento</h5>
                                          <!-- /titulo tus productos -->
                                          ...
                                          <table class="table" style="border-collapse: collapse; border-spacing: 0px; font-family: Helvetica, Arial, sans-serif; margin-bottom: 16px; max-width: 100%; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff"
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                                <td style="border-collapse: collapse; border-spacing: 0px; border-top: 0; font-size: 16px; line-height: 24px; margin: 0; padding: 12px;" valign="top">Origen</td>
                                                <td style="border-collapse: collapse; border-spacing: 0px; border-top: 0; font-size: 16px; line-height: 24px; margin: 0; padding: 12px;" class="text-right" valign="top" align="right"><?=$contacto['Contacto']['origen']; ?></td>
                                              </tr>

                                              <tr>
                                                <td style="border-collapse: collapse; border-spacing: 0px; border-top: 0; font-size: 16px; line-height: 24px; margin: 0; padding: 12px;" valign="top">Asunto</td>
                                                <td style="border-collapse: collapse; border-spacing: 0px; border-top: 0; font-size: 16px; line-height: 24px; margin: 0; padding: 12px;" class="text-right" valign="top" align="right"><?=$contacto['Contacto']['asunto']; ?></td>
                                              </tr>

                                              <? if (!empty($contacto['Contacto']['mensaje'])) : ?>
                                              <tr>
                                                <td style="border-collapse: collapse; border-spacing: 0px; border-top: 0; font-size: 16px; line-height: 24px; margin: 0; padding: 12px;" valign="top">Mensaje</td>
                                                <td style="border-collapse: collapse; border-spacing: 0px; border-top: 0; font-size: 16px; line-height: 24px; margin: 0; padding: 12px;" class="text-right" valign="top" align="right"><?=$contacto['Contacto']['mensaje']; ?></td>
                                              </tr>
                                              <? endif; ?>

                                              <tr>
                                                <td style="border-collapse: collapse; border-spacing: 0px; border-top: 0; font-size: 16px; line-height: 24px; margin: 0; padding: 12px;" valign="top">Fecha de creación</td>
                                                <td style="border-collapse: collapse; border-spacing: 0px; border-top: 0; font-size: 16px; line-height: 24px; margin: 0; padding: 12px;" class="text-right" valign="top" align="right"><?=$contacto['Contacto']['created']; ?></td>
                                              </tr>
                                          ...
                                          <a href="<?=$url;?>cliente/contactos/confirmar/<?=$contacto['Contacto']['id']; ?>?access_token=<?=$token;?>&action=ok" style="padding: 10px 10px; background-color: #F55A00; color: #fff; font-size: 18px; display: block; margin: 15px 0; border-radius: 5px; text-align: center;">Sí, un ejecutivo resolvió mi requerimiento.</a>
                                          
                                          <a href="<?=$url;?>cliente/contactos/confirmar/<?=$contacto['Contacto']['id']; ?>?access_token=<?=$token;?>&action=none" style="padding: 10px 10px; background-color: #294D99; color: #fff; font-size: 18px; display: block; margin: 15px 0; border-radius: 5px; text-align: center;">No, no me han ayudado aun.</a>
                                          <!-- Parrafo -->
                                          <p class="text-muted text-center" style="color: #636c72; font-size: 16px; font-weight: 500; line-height: 22px; margin-bottom: 10px; text-align: center; vertical-align: baseline;">La confirmación de su requerimiento tiene una vigencia de 7 días a partir de la recepción de este email. Por favor no ignore este mensaje, ya que así nos ayuda a mejorar.</p>
                                          <!-- /Parrafo -->
                      ...
                      <tbody>
                        <tr>
                          <td style="border-bottom: 0; border-collapse: collapse; border-spacing: 0px; border-top: 0; font-size: 16px; line-height: 24px; margin: 0; padding: 20px" align="left">
                              ...
                              <font color="636c72" font-size="13" style="font-size: 13px; line-height: 16px;"><?=$contacto['Tienda']['direccion'];?><br>
