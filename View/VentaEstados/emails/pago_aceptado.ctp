                                    ...
                                    <tr>
                                      <td style="border-collapse: collapse; border-spacing: 0px; font-size: 16px; line-height: 24px; margin: 0; padding: 20px;" width="100%">
                                        <div>
                                          ...
                                          <!-- Titulo -->
                                          <h4 class="text-center" style="color: inherit; font-size: 24px; font-weight: 500; line-height: 26.4px; margin-top: 30px; margin-bottom: 30px; text-align: center; vertical-align: baseline;">¡Felicidades! Tu pago ha sido aceptado</h4>
                                          <!-- /Titulo -->
                                          ...
                                          <!-- Sub titulo -->
                                          <h5 class="text-muted text-center" style="color: #636c72; font-size: 20px; font-weight: 700; line-height: 22px; margin-bottom: 0px; margin-top: 0px; text-align: center; vertical-align: baseline;">¿Qué hago ahora?</h5>
                                          <!-- /Sub titulo -->
