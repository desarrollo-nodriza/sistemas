                                      ...
                                      <td style="border-collapse: collapse; border-spacing: 0px; font-size: 16px; line-height: 24px; margin: 0; padding: 20px;" width="100%">
                                        <div>
                                          ...
                                          <div style="text-align: center;">
                                            <img src="https://sistemasdev.nodriza.cl/img/toolmania/iconos/clock.png" style="max-width: 100%; margin-top: 40px;" width="50">
                                          </div>
                                          <h4 class="text-center" style="color: inherit; font-size: 24px; font-weight: 500; line-height: 26.4px; margin-top: 0px; margin-bottom: 30px; text-align: center; vertical-align: baseline;"> Estamos preparando tu pedido</h4>
                                          <!-- /Titulo -->
