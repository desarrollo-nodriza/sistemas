                                      ...
                                      <td style="border-collapse: collapse; border-spacing: 0px; font-size: 16px; line-height: 24px; margin: 0; padding: 20px;" width="100%">
                                        <div>
                                          ...
                                          <div style="text-align: center;">
                                            <img src="https://sistemasdev.nodriza.cl/img/toolmania/iconos/error.png" style="max-width: 100%; margin-top: 40px;" width="50">
                                          </div>
                                          <h4 class="text-center" style="color: inherit; font-size: 24px; font-weight: 500; line-height: 26.4px; margin-top: 10px; margin-bottom: 30px; text-align: center; vertical-align: baseline;">Error al recibir tu pago</h4>
                                          <!-- /Titulo -->
                                          ...
                                          <!-- Sub titulo -->
                                          <h5 class="text-muted text-center" style="color: #636c72; font-size: 20px; font-weight: 700; line-height: 22px; margin-bottom: 0px; margin-top: 0px; text-align: center; vertical-align: baseline;">¿Por qué falló mi compra?</h5>
                                          <!-- /Sub titulo -->
                                          ...
                                          <!-- Parrafo -->
                                          <p class="text-muted text-center" style="color: #636c72; font-size: 16px; font-weight: 500; line-height: 22px; margin-bottom: 10px; margin-top: 0px; text-align: center; vertical-align: baseline;">Entre las posibles causas de errores de pago se encuentran:</p>
                                          
                                          <ul class="text-muted" style="color: #636c72; font-size: 14px; line-height: 18px; margin-bottom: 0px; margin-top: 0px; list-style: none; text-align: center; padding: 0;">
                                            <li>Cupo diario excedido</li>
                                            <li>Cancelación de la compra</li>
                                            <li>Tarjeta sin cupo suficiente</li>
                                            <li>Tiempo de pago superado</li>
                                            <li>Error con los datos de su tarjeta</li>
                                          </ul>
