						...
						<table class="table">
							...
							<tbody>
								...
								<tr>
									...
									<? if ($permisos['edit']) : ?>
									<td><?= $this->Html->link('<i class="fa fa-eye"></i> Ver detalle', array('controller' => 'ordenes','action' => 'editar', $dte['Dte']['id']), array('class' => 'btn btn-xs btn-info', 'rel' => 'tooltip', 'title' => 'Ver este registro', 'escape' => false)); ?></td>
									<? endif; ?>
								</tr>
								<?php endforeach; ?>
							</tbody>
