<div class="page-title">
	<h2><span class="fa fa-tags"></span> Creación masiva</h2>
</div>

<?= $this->Form->create('Zona', array('inputDefaults' => array('div' => false, 'label' => false), 'class' => 'js-formulario', 'type' => 'file')); ?>
...
<div class="page-content-wrap">
	...
	<div class="row">
				...
				<div class="panel-body">
					...
					<div class="form-group col-xs-12 col-md-6">
						...
						<?=$this->Form->input('archivo', array(
							'class' => '<?=(empty($this->Session->read("creacionMasivaZonas"))) ? "not-blank" : "" ; ?>',
							'type' => 'file'
							))?>
					</div>
				</div>
		...
		<div class="col-xs-12">
			<? if (!empty($this->Session->read('creacionMasivaZonas.options'))) : ?>
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">Listando <?= count($this->Session->read('creacionMasivaZonas.options')); ?> itemes</h3>
				</div>
				<div class="panel-body">
					...
					<div class="table-responsive" style="max-height: 350px; overflow-y: auto;">
						<table class="table table-bordered" >
							...
							<thead>
								<? foreach ($this->Session->read('creacionMasivaZonas.options') as $i => $cabecera) : ?>
								<th>
							...
							<tbody class="js-body">
							<? foreach ($this->Session->read('creacionMasivaZonas.data') as $id => $valor) : if ($id == 1) continue; ?>
							<tr>
								<? foreach ($this->Session->read('creacionMasivaZonas.options') as $i => $op) : ?>
