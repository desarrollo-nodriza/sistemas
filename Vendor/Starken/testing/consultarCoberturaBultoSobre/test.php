<?php
/**
 * Test consultarCoberturaBultoSobre.
...
$response = $starkenWs->consultarCoberturaBultoSobre($request, true);
...
<html lang="es">
	<head>
		<meta charset="UTF-8">
		<title>Test consultarCoberturaBultoSobre</title>
	</head>
<body>
	<div>
		<h3>Test consultarCoberturaBultoSobre</h3>
		<h4>Request:</h4>
