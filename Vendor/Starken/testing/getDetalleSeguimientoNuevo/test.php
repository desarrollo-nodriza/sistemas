<?php
/**
 * Test getDetalleSeguimientoNuevo.
...
$response = $starkenWs->getDetalleSeguimientoNuevo($request, true);
...
<html lang="es">
	<head>
		<meta charset="UTF-8">
		<title>Test getDetalleSeguimientoNuevo</title>
	</head>
<body>
	<div>
		<h3>Test getDetalleSeguimientoNuevo</h3>
		<h4>Request:</h4>
