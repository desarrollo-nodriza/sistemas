(function ($) {
  ...
  Selectpicker.prototype = {
      ...
      this.$menu.on('click', 'li a', function (e) {
        ...
        if (!that.isDisabled() && !$(this).parent().hasClass('disabled')) {
          ...
          //Else toggle the one we have chosen if we are multi select.
            ...
            $option.prop('selected', !state).attr('selected', !state);
            ...
            if ((maxOptions !== false) || (maxOptionsGrp !== false)) {
              ...
              if ((maxOptions && maxReached) || (maxOptionsGrp && maxReachedGrp)) {
                if (maxOptions && maxOptions == 1) {
                  ...
                  $optgroup.find('option:selected').prop('selected', false).attr('selected', false);
                  $option.prop('selected', true).attr('selected', true);
                  ...
                  $option.prop('selected', false).attr('selected', false);
    ...
    selectAll: function () {
      if (this.$lis == null) this.$lis = this.$menu.find('li');
      this.$element.find('option:enabled').prop('selected', true).attr('selected', true);
    ...
    deselectAll: function () {
      if (this.$lis == null) this.$lis = this.$menu.find('li');
      this.$element.find('option:enabled').prop('selected', false).attr('selected', false);
